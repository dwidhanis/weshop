<?php
    ...
    if($barang_id) {
        ...
        $keterangan_gambar = "(Klik pilih file untuk mengubah gambar)";
        // menampilkan gambar
...
<form action="<?php echo BASE_URL."module/barang/action.php?barang_id=$barang_id"; ?>" method="POST" enctype="multipart/form-data">
                ...
                <?php
                    ...
                    while($row=mysqli_fetch_assoc($query)){
                        if($kategori_id == $row['kategori_id']){
                            echo "<option value='$row[kategori_id]' selected='true'>$row[kategori]</option>"; //selected true untuk mengecek default kategori
                        }else{
    ...
    <div style="margin-bottom: 10px;">
        ...
        <span><textarea name="spesifikasi" id="editor" cols="" rows=""><?php echo $spesifikasi ?></textarea></span>
    </div>
